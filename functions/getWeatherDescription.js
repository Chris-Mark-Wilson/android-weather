export const getWeatherDescription = (weatherCode,isDay) => {
    const lookup={
        ...
        "10":["mist","Mist"],
        "11":["mist","Patchy shallow fog or ice fog at the station, whether on land or sea, not deeper than about 2 metres on land or 10 metres at sea"],
        "12":["mist","More or less continuous shallow fog or ice fog at the station, whether on land or sea, not deeper than about 2 metres on land or 10 metres at sea, covering less than half the sky"],
        ...
        "40":["fog","Fog or ice fog at a distance at the time of observation, but not at the station during the preceding hour, the fog or ice fog extending to a level above that of the observer"],
        ...
        "45":["fog","Fog or ice fog, sky invisible, no appreciable change during the preceding hour"],
        "46":["fog","Fog or ice fog, sky visible, has begun or has become thicker during the preceding hour"],
