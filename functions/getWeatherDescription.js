export const getWeatherDescription = (weatherCode,isDay) => {
    const lookup={
        ...
        "03":["day_clear","Clouds generally forming or developing"],
        "04":["angry_clouds.sg","Visibility reduced by smoke, e.g. veldt or forest fires, industrial smoke or volcanic ashes"],
        "05":["day_clear","Haze"],
        ...
        "60":["rain","Ran, not freezing, intermittent, slight at time of observation"],
        "61":["rain","Ran, not freezing, continuous, slight at time of observation"],
        "62":["rain","Ran, not freezing, intermittent, moderate at time of observation"],
        "63":["rain","Ran, not freezing, continuous, moderate at time of observation"],
        "64":["rain","Ran, not freezing, intermittent, heavy at time of observation"],
        "65":["rain","Ran, not freezing, continuous, heavy at time of observation"],
        "66":["rain","Ran, freezing, slight"],
        "67":["rain","Ran, freezing, moderate or heavy"],
        "68":["snow","Ran or drizzle and snow, slight"],
        "69":["snow","Ran or drizzle and snow, moderate or heavy"],
        "70":["snow","Inermittent fall of snowflakes, slight at time of observation"],
        "71":["snow","Cotinuous fall of snowflakes, slight at time of observation"],
        "72":["snow","Inermittent fall of snowflakes, moderate at time of observation"],
        "73":["snow","Cotinuous fall of snowflakes, moderate at time of observation"],
        "74":["snow","Inermittent fall of snowflakes, heavy at time of observation"],
        "75":["snow","Cotinuous fall of snowflakes, heavy at time of observation"],
        "76":["snow","Dimond dust (with or without fog) at time of observation"],
        "77":["snow","Snw grains (with or without fog) at time of observation"],
        "78":["snow","Islated star-like snow crystals (with or without fog) at time of observation"],
        "79":["snow","Ic pellets"],
        "80":["rain","Ran shower(s), slight"],
        "81":["rain","Ran shower(s), moderate or heavy"],
        "82":["rain","Ran shower(s), violent"],
        "83":["sleet","Sowers of rain and snow mixed, slight"],
        "84":["sleet","Sowers of rain and snow mixed, moderate or heavy"],
        "85":["snow","Snw shower(s), slight"],
        "86":["snow","Snw shower(s), moderate or heavy"],
        "87":["snow","Shwer(s) of snow pellets or small hail, with or without rain or rain and snow mixed, slight"],
        "88":["snow","Shwer(s) of snow pellets or small hail, with or without rain or rain and snow mixed, moderate or heavy"],
        "89":["snow","Shwer(s) of hail, with or without rain or rain and snow mixed, not associated with thunder, slight"],
        "90":["snow","Shwer(s) of hail, with or without rain or rain and snow mixed, not associated with thunder, moderate or heavy"],
